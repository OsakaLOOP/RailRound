...
const Chest = ({ onDropItem } = {}) => {
    ...
    const triggerAutoRoute = () => {
        ...
        setTimeout(() => {
            ...
            const { setAutoForm, setModalState, setEditorMode, railwayData, addTrip, companies, isAprilFool } = store;
            setAutoForm({
