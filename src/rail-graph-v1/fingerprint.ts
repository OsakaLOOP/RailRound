// ============================================================
// Rail Graph v1 - Canonical JSON and SHA-256 fingerprints
// ============================================================
...
function canonicalize(value: unknown): unknown {
  ...
  if (value instanceof Map) {
    return canonicalize(Object.fromEntries([...value.entries()].sort(([a], [b]) => String(a).localeCompare(String(b)))));
  }
  if (value instanceof Set) {
    return [...value.values()].map(canonicalize).sort((a, b) => canonicalJson(a).localeCompare(canonicalJson(b)));
  }
