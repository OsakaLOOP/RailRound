...
import { isCompanyCompatible, getTransferableLines, computeLoopVia, getSegmentKey } from './core/railwayRouting';
    ...
    const autoLoadData = async () => {
        ...
        try {
            ...
            const processGeoJsonBatch = (items: any[], companyData = currentCompanyData) => {
                const { newFeatures, railwayUpdates } = parseGeoJsonBatch(items, companyData);
