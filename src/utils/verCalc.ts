...
export interface VerCmpResult {
    diff: number;
    at: 'major' | 'minor' | 'patch';
}

// 版本号定义, 格式: "主版本.次版本(一个数字)+修订号(任意位数)", 例如 "0.30, 0.314"
export const verCalc = (verStr: string): Ver => {
...
// 版本号比较
export const verCmp = (ver1: string, ver2: string): VerCmpResult => {
...
export const isVerSupported = (ver1: string, ver2: string): boolean => {
