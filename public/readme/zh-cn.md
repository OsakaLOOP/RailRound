...
* **与不可名状的 py 交易**
    ...
    * **数据源**: **[国土交通省 (MLIT)](https://www.mlit.go.jp)**, **[ODPT](https://www.odpt.org)**, **[Ekidata](https://ekidata.jp)** 和 **[LOD](https://lod.org)**. (见开源协议)
...
3.  **Ekidata 大引入**: 引入换乘数据, 让路径规划看起来不那么像是在掷骰子, 或者 [西園寺](https://www.youtube.com/@SAIONJI_O) 和 [スーツ旅行](https://www.youtube.com/@SuitTravel) 的大回り乗車罰ゲーム.
